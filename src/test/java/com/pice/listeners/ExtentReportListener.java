...
import com.pice.utils.ScreenshotUtils;
...
public class ExtentReportListener implements ITestListener, ISuiteListener {
    ...
    private static String customCss() {
        return "@import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap');\n"
            + "body { font-family: 'Inter', sans-serif !important; background-color: #0f172a !important; color: #f8fafc !important; }\n"
            + ".header { background-color: #1e293b !important; border-bottom: 1px solid #334155 !important; }\n"
            + ".nav-logo span { color: #818cf8 !important; font-weight: 700 !important; }\n"
            + ".test-content { border-left: 4px solid #6366f1 !important; padding-left: 12px !important; }\n"
            + ".badge-primary, .test-wrapper .nav-tabs .nav-link.active, .test-wrapper .tab-content .tab-pane.active { background-color: #6366f1 !important; color: #ffffff !important; }\n"
            + ".status.pass, .badge-pass { background-color: #10b981 !important; color: #ffffff !important; font-weight: 600 !important; }\n"
            + ".status.fail, .badge-fail { background-color: #f43f5e !important; color: #ffffff !important; font-weight: 600 !important; }\n"
            + ".status.skip, .badge-skip { background-color: #f59e0b !important; color: #ffffff !important; font-weight: 600 !important; }\n"
            + ".card { background-color: #1e293b !important; border: 1px solid #334155 !important; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1) !important; border-radius: 8px !important; }\n"
            + ".table { color: #cbd5e1 !important; }\n"
            + ".table-bordered th, .table-bordered td { border: 1px solid #334155 !important; }";
    }
}
