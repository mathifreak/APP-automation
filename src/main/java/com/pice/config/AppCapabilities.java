...
import com.pice.driver.DeviceType;
...
public final class AppCapabilities {
    ...
    private static UiAutomator2Options buildAndroidCapabilities() {
        ...
        // Set app path — APK file is MANDATORY unless app.install=false
        boolean installApp = ConfigManager.getBoolean("app.install", true);
        if (installApp) {
            ...
            log.info("Skipping setting APK path / app capability because 'app.install' is set to false. Using already installed package.");
        }
